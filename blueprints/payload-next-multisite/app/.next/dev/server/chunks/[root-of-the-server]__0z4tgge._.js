...
"[project]/blueprints/payload-next-multisite/app/src/app/(frontend)/robots.txt/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const GET = async ()=>{
    ...
    if (!site.tenant.indexingEnabled) {
        ...
        lines.push('Allow: /');
        lines.push('');
        lines.push(`Sitemap: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$blueprints$2f$payload$2d$next$2d$multisite$2f$app$2f$src$2f$seo$2f$metadata$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["absoluteUrl"])(site.tenant, '/sitemap.xml')}`);
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0z4tgge._.js.map