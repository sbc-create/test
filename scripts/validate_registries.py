...
MAPPING = {
    ...
    # Словарь тегов поставщика каталога. Сопоставлен здесь, а не в
    # исключениях: файл, не проверяемый никем, — это и есть та дыра, ради
    # закрытия которой сопоставление сделано явным.
    "catalog-tag-vocabulary.json": "catalog-tag-vocabulary.schema.json",
}
