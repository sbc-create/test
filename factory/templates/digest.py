...
TEMPLATE_SOURCES: tuple[str, ...] = (
    ...
    # Единое отображение сущности в адрес. Появилось в ZONE-TPL-001 и в
    # отпечаток не попало: правка правила адресов меняла бы каждую страницу,
    # не двигая версию артефакта. Пробел нашла проверка покрытия, а не человек.
    "factory/lords/urlmap.py",
