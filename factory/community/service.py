    ...
    def get_rating(
        ...
        *,
        ...
        body: dict[str, Any] = {
            ...
            else str(round_display(native.average)),
            "native_vote_count": native.vote_count,
            "native_absent": native.vote_count == 0,
            "native_absent_label": "Пока нет оценок" if native.vote_count == 0 else None,
        ...
        if rating_space_id == "yummy":
            ...
            pub = YummyPublic(native.vote_sum, native.vote_count, prior, m=int(inp.get("m") or DEFAULT_PRIOR_STRENGTH_M))
    ...
    def preview_one(
        ...
        *,
        ...
        return {
            "action": action,
            "score": score,
            "before": None if before is None else str(round_display(before, "0.001")),
            "after": None if after is None else str(round_display(after, "0.001")),
