...
ПРОБНЫЕ_ТЕЛА = {
    # Выдача связей читающая, но обслуживается управляющим слоем, поэтому
    # опрашивается здесь. Предел в одну запись — чтобы проверка описания не
    ...
    "/api/v1/site-requests/{requestId}/approve": {"planHash": "sha256:нет"},
    ...
    "/api/v1/state-backup": {"verify": False},
    "/api/v1/releases": {},
    "/api/v1/incidents": {},
    ...
    "/api/v1/overview": {},
    "/api/v1/content": {"siteId": "lords-01"},
