...
PUSH_PERFORMED=1  # только ветка claude/zona-real-slider-01
```
...
* **Пакеты T001–T050 для Zona не существовали** — ни в этой ветке, ни в
  других ветках Zona. Одноимённые пакеты нашлись только в лентах Lords
  ...
  Поэтому T001–T050 собраны заново в собственном слое Zona — таблицей из
  пятидесяти объявлений поверх общей отрисовки. Все пятьдесят прошли ту же
  приёмку, что и кандидат.
