# Backlog lords-02 (lordserial33.biz)

Profile: `lords-new` — keep visual identity independent.
...
## Deploy rule
Site-scoped cycle: tests → stage → rollback point → restart **only** `lords-02` unit → two stable live runs before next site.
