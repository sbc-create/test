# Backlog lords-01 (lordfilm47.space)

Profile: `lords-general` — keep visual identity independent.
...
## Deploy rule
Site-scoped cycle: tests → stage → rollback point → restart **only** `lords-01` unit → two stable live runs before next site.
