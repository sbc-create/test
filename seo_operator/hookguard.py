...
# Cursor exposes StrReplace/Delete/EditNotebook; Claude Code used Edit/MultiEdit.
...
# Cursor CLI/agent harness names the shell tool "Shell"; Claude Code used "Bash".
# Treat them identically so UNATTENDED_SAFE does not fail-closed on every command.
