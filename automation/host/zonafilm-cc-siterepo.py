...
def main() -> int:
    ...
    runtime = {
        ...
        "metrika_note": (
            "BLOCKED_EXTERNAL_CREDENTIAL: собственный счётчик zonafilm.cc не создан. "
            "Пустое значение означает «счётчика нет», а не «возьми соседний»: "
            "чужой счётчик писал бы события не туда."),
